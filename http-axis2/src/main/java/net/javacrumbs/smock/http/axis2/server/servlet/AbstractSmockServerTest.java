...
public abstract class AbstractSmockServerTest extends AbstractHttpSmockServerTest {
	...
	protected ServletBasedMockWebServiceClient createClient(ApplicationContext applicationContext, ClientInterceptor[] interceptors) {
		return SmockServer.createClient(getServiceRepositoryPath(), applicationContext, interceptors);
	}

	/**
	 * Specifies location of Axis2 services directory. To be overriden.
	 * @return
	 */
	protected abstract String getServiceRepositoryPath();
}
