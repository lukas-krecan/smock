...
public abstract class AbstractSmockServerTest extends AbstractCommonSmockServerTest {
	...
	protected  ServletBasedMockWebServiceClient mockWebServiceClient;
	/**
	...
	protected ServletBasedMockWebServiceClient getMockWebServiceClient() {
		return mockWebServiceClient;
	}
	protected void setMockWebServiceClient(ServletBasedMockWebServiceClient mockWebServiceClient) {
