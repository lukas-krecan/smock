...
class SpringWsSmockMockWebServiceClient implements SmockMockWebServiceClient
{
	private final MockWebServiceClient client;

	public SpringWsSmockMockWebServiceClient(MockWebServiceClient client) {
		this.client = client;
	}

	public ResponseActions sendRequest(RequestCreator requestCreator) {
		return client.sendRequest(requestCreator);
	}
